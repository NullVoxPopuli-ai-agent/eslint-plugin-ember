  ...
  create(context) {
    ...
    return {
      GlimmerElementNode(node) {
        ...
        // In strict mode (gjs/gts), capitalized Input/Textarea are Ember's built-in
        // components and may not be actual HTML elements. Skip them to avoid false positives.
